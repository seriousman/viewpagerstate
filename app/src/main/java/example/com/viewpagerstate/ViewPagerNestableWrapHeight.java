...
public class ViewPagerNestableWrapHeight extends ViewPagerNestable {

	public ViewPagerNestableWrapHeight(Context context) {
		super(context);
	}
	public ViewPagerNestableWrapHeight(Context context, AttributeSet attrs) {
		super(context, attrs);
	}
